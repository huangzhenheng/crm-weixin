...
public class WxErrorCode {
	...
	static {
		...
		ERRORCODEMAP.put("40001", "获取 access_token 时 AppSecret 错误，或者 access_token 无效。");
		...
		ERRORCODEMAP.put("40060","删除单篇图文时，指定的article_idx不合法");
		...
		ERRORCODEMAP.put("41008","缺少oauthcode");
		ERRORCODEMAP.put("41009","缺少openid");
		ERRORCODEMAP.put("42001","access_token超时，请检查access_token的有效期");
		ERRORCODEMAP.put("42002","refresh_token超时");
		ERRORCODEMAP.put("42003","oauth_code超时");
		ERRORCODEMAP.put("42007","用户修改微信密码，accesstoken和refreshtoken失效，需要重新授权");
		...
		ERRORCODEMAP.put("43019","需要将接收者从黑名单中移除");
		...
		ERRORCODEMAP.put("45011","API调用太频繁，请稍候再试");
		...
		ERRORCODEMAP.put("45047","客服接口下行条数超过上限");
		...
		ERRORCODEMAP.put("48002","粉丝拒收消息（粉丝在公众号选项中，关闭了“接收消息”）");
		ERRORCODEMAP.put("48004","api接口被封禁，请登录mp.weixin.qq.com查看详情");
		ERRORCODEMAP.put("48005","api禁止删除被自动回复和自定义菜单引用的素材");
		ERRORCODEMAP.put("48006","api禁止清零调用次数，因为清零次数达到上限");
		ERRORCODEMAP.put("48008","没有该类型消息的发送权限");
		ERRORCODEMAP.put("50001","用户未授权该api");
		ERRORCODEMAP.put("50002","用户受限，可能是违规后接口被封禁");
		ERRORCODEMAP.put("61451","参数错误(invalidparameter)");
		ERRORCODEMAP.put("61452","无效客服账号(invalidkf_account)");
		ERRORCODEMAP.put("61453","客服帐号已存在(kf_accountexsited)");
		ERRORCODEMAP.put("61454","客服帐号名长度超过限制(仅允许10个英文字符，不包括@及@后的公众号的微信号)(invalidkf_acountlength)");
		ERRORCODEMAP.put("61455","客服帐号名包含非法字符(仅允许英文+数字)(illegalcharacterinkf_account)");
		ERRORCODEMAP.put("61456","客服帐号个数超过限制(10个客服账号)(kf_accountcountexceeded)");
		ERRORCODEMAP.put("61457","无效头像文件类型(invalidfiletype)");
		ERRORCODEMAP.put("61450","系统错误(systemerror)");
		ERRORCODEMAP.put("61500","日期格式错误");
		ERRORCODEMAP.put("65301","不存在此menuid对应的个性化菜单");
		ERRORCODEMAP.put("65302","没有相应的用户");
		ERRORCODEMAP.put("65303","没有默认菜单，不能创建个性化菜单");
		ERRORCODEMAP.put("65304","MatchRule信息为空");
		ERRORCODEMAP.put("65305","个性化菜单数量受限");
		ERRORCODEMAP.put("65306","不支持个性化菜单的帐号");
		ERRORCODEMAP.put("65307","个性化菜单信息为空");
		ERRORCODEMAP.put("65308","包含没有响应类型的button");
		ERRORCODEMAP.put("65309","个性化菜单开关处于关闭状态");
		ERRORCODEMAP.put("65310","填写了省份或城市信息，国家信息不能为空");
		ERRORCODEMAP.put("65311","填写了城市信息，省份信息不能为空");
		ERRORCODEMAP.put("65312","不合法的国家信息");
		ERRORCODEMAP.put("65313","不合法的省份信息");
		ERRORCODEMAP.put("65314","不合法的城市信息");
		ERRORCODEMAP.put("65316","该公众号的菜单设置了过多的域名外跳（最多跳转到3个域名的链接）");
		ERRORCODEMAP.put("65317","不合法的URL");
